...
class Ui_Dialog(object):    
    ...
    def setupUi(self, Dialog):
        ...
        for i in range(20, 460, 110):
            ...
            for j in range(50, 200, 30):
                ...
                button.clicked.connect(lambda ch, button=button: self.choiceButtonClicked(button)) # connect button to function (HERE IS THE MISSING BIT)
    ...
    def choiceButtonClicked(self, button):
        #print('Button no. ' + str(iNo) + ' was pressed...')
